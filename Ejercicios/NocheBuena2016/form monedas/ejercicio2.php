...
$monedas1 = array('EU','DL','LB');
$SELECTED_KEY = $_POST['moneda1'];
$SELECTED_VAL1 = $monedas1[$SELECTED_KEY];
$valor1=
print_r($SELECTED_KEY);

$monedas2 = array('EU','DL','LB');
$SELECTED_KEY = $_POST['moneda2'];
$SELECTED_VAL2= $monedas2[$SELECTED_KEY];
print_r($SELECTED_KEY);
